    ...
    return (
        <>
            <div className="flex flex-col h-screen gap-5">
                ...
                {/* bottom */}
                <div style={{ height: "85%" }} className=" flex-wrap flex items-center justify-center">
                    {/* left */}
                    <div data-aos="fade-left" data-aos-delay="0" className="h-full flex flex-col justify-around | md:w-3/5 md:px-6
              
              ">
                        <p className=" px-4 text-[#ABB2BF] text-[17px] text-center | md:text-[16px] md:text-center | lg:text-[19px]">
                    ...
                    {/* right */}
                    <div className="h-full w-0 items-center justify-center | hidden md:flex | md:w-2/5 md:relative md:bottom-20
              ">
                        <div className=" w-[350px] h-[350px] flex justify-center items-center rounded-b-full rounded-tl-full shadow-2xl bg-slate-800 shadow-slate-700 md:w-[250px] md:h-[300px] lg:w-[300px] lg:h-[350px]">
